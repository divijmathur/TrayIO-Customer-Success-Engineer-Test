...
// function describing the notation for specific directions and what the roomba should do when givin these specific directions
...
// we're checking here what patch has been cleaned by our roomba
function dirtCheck(){
...
// split the room dimensions that have been given to us
var dimensionOfRoom= fileContent[0].split(' ');

// split the starting point of roomba that is given to us
...
// we'll output the final position of the roomba after it is done cleaning the patches and also output the number of dirt patches it cleaned on the console.
